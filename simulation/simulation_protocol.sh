...
### GRCh38 v3 ###
#################
# simulation_protocol.sh -d ./ -r HG02716_template.fa -t /data/tusers/zhongrenhu/for_SMS/reference/GRCh38.p13/GRCh38.transposon.fa -N 100 -R 0 --sub-N 5 --germline-count 5000 --avg-somatic-count 1000 --min-distance 6000 --depth 50 --species human --protocol ccs