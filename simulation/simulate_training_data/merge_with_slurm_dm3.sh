...
################################
[ -z $FILELIST ] && FILELIST=/data/tusers/zhongrenhu/for_SMS/dna/simulation/dm3/v4/merge_filelist
[ -z $CONTIGS ] && CONTIGS=(`cut -f 1 /data/tusers.ds/zhongrenhu/for_SMS/dna/simulation/dm3/template/line_28/line_28_template.fa.fai`)
