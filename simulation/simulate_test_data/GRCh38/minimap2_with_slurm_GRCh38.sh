...
#SBATCH --output=./logs/Minimap2/GRCh38/minimap2-log-%A-%a.out
...
################################
[ -z $FILELIST ] && FILELIST=/data/tusers/zhongrenhu/for_SMS/dna/simulation/GRCh38/benchmark/minimap2_filelist
