...
#SBATCH --output=./logs/Label/Dm3/label-log-%A-%a.out
...
[ -z $CONTIGS ] && CONTIGS=(`cut -f 1 /data/tusers/zhongrenhu/for_SMS/dna/simulation/dm3/template/line_21/line_21_template.fa.fai`)
