...
################################
# [ -z $FILELIST ] && FILELIST=/data/tusers.ds/zhongrenhu/for_SMS/dna/simulation/dm3/v1/line_21_0/simulation_filelist
# [ -z $FILELIST ] && FILELIST=/data/tusers.ds/zhongrenhu/for_SMS/dna/simulation/dm3/v3/line_21_0/simulation_filelist
# [ -z $FILELIST ] && FILELIST=/data/tusers.ds/zhongrenhu/for_SMS/dna/simulation/dm3/v4_test/line_21_0_ccs/simulation_filelist
[ -z $FILELIST ] && FILELIST=/data/tusers.ds/zhongrenhu/for_SMS/dna/simulation/dm3/v4/line_21_0_ccs/simulation_filelist
